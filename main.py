...
class App:
    ...
    def barcode(self):
        ...
        if len(gtin)==14 and len(sn)==13:
            barcode = f'01{gtin}21{sn}91EE06920NidnltXYq8A+0UOHQ0oFxPgpBdtVmLMvt4SbY6C0m4='
        elif len(gtin_sn)==27:
    ...
    def data_matrix(self):
        ...
        text=self.txt_code.get('1.0', END).rstrip()
        text=text.encode("utf-8")
        text=base64.b64encode(text)
        text=text.decode('utf-8')
        self.txt_bs64.delete('1.0',END)
        self.txt_bs64.insert(1.0,text)
        self.txt_bs64.config(state=DISABLED)
...
'0104601808010398210000000000RH691EE06928b0a1+3cl66k4Eay7I7zYb3EJGfRZvAEmUDYRWYLbac='
app = App()
"04601808010398"
"0000000000RH6"
